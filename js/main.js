...
function aboutDivison()
{
    ...
    aboutDiv.append("<div class=\"mdl-cell mdl-cell--6-col\"><div class=\"demo-card-wide mdl-card mdl-shadow--2dp\" style=\"background: transparent\"><div class=\"mdl-card__supporting-text\"><h1>About Us</h1><p>"+aboutUsText+ "</p></div></div></div>")
    aboutDiv.append("<div class=\"mdl-cell mdl-cell--3-col\"></div>");
...
function mainDivison()
{
    ...
    mainDiv.empty();
    mainDiv.append("<div class=\"mdl-cell mdl-cell--12-col\"><div class=\"demo-card-wide mdl-card mdl-shadow--2dp\" style=\"background: transparent\"><div class=\"mdl-card__supporting-text\" id=\"product_grid\" style=\"width:100%; padding:0px\"></div></div></div>");
...
function createCard(object,id){
    object.append("<div class=\"mdl-cell mdl-cell--12-col\"><div class=\"demo-card-wide mdl-card mdl-shadow--2dp\" style=\"background: transparent\"><div class=\"mdl-card__supporting-text\" id=\"" +id + "\"></div></div></div>");
}
